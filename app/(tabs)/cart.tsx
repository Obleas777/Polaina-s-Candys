...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    alignItems: 'center',
    marginTop: 20, // Añadir espacio superior al encabezado
  },
  headerTitle: {
    fontSize: 18,
    fontWeight: 'bold',
    color: '#333',
    marginTop: 20, // Mueve el texto hacia abajo dentro del encabezado
  },
  cartContainer: {
    padding: 15,
  },
  cartItem: {
    ...
    alignItems: 'center',
    paddingVertical: 10,
    paddingHorizontal: 15, // Añade padding horizontal para separar el contenido de los bordes
    borderBottomWidth: 1,
    borderBottomColor: '#ddd',
    backgroundColor: '#fff',
    marginBottom: 10,
  ...
  checkoutButton: {
    backgroundColor: '#232F3E', // Gris oscuro
    borderRadius: 5,
    paddingVertical: 10,
